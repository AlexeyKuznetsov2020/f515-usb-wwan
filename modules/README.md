...
| `rndis_host.ko` | автономный RNDIS поверх `usbnet` (MTS 81332FT, ZTE MF90) | RNDIS / HiLink |
...
- `src/rndis/` — автономный `rndis_host.c` с встроенным CDC-биндингом (не зависящим от
